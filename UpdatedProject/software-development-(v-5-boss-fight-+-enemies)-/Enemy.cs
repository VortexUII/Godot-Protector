...
public partial class Enemy : CharacterBody2D
{
	...
	public override void _Ready()
	{
		...
		_hurtSound = GetNode<AudioStreamPlayer2D>("Orc_Hurt");
		_deathSound = GetNode<AudioStreamPlayer2D>("Orc_Death");
		_attackSound = GetNode<AudioStreamPlayer2D>("Orc_Attack");
	...
	private async void TryAttack()
	{
		...
		if (heavyAttack)
		{
			_animatedSprite.Play("orc_charged");
			_hitbox.Damage = 10;
		}
		else
		{
			_animatedSprite.Play("orc_attack");
			_hitbox.Damage = 5;
		}
	...
	private async void Die()
	{
		...
		_animatedSprite.Play("orc_death");
